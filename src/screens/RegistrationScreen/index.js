...
export default class RegistrationScreen extends Component {
  ...
  Register = async () => {
    ...
    const response = await callApi('registration', 'POST', param)
  ...
  render() {
    const { registered_for_GST, read_aggremenet_chekbox } = this.state;
    return (
              ...
              <View style={styles.inputContent}>
                ...
                <View style={[styles.inputItem, { borderBottomWidth: 0 }]}>
                  ...
                  <View style={{ flex: 1 }}>
                    <TouchableOpacity
                      onPress={() =>
                        this.setState({ read_aggremenet_chekbox: !this.state.read_aggremenet_chekbox })
                      }>
                      {Platform.OS === 'ios' ? (
                        <Text
